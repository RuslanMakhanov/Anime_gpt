...
messages = [
    {
        "role": "system",
        "content": f"Ты ведущий текстовой РПГ, ты придумываешь сеттинг в рандомном стиле,"
                   f"первым сообщением ты рассказываешь мини историю персонажа."
                   f"Тебе нужно писать действия что бы игрок их выбирал и на основе их делать действия."
                   f"Старайся делать все коротко и информативно."
    }
]
